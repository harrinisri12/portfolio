            ...
            <form onSubmit={submitFeedback} className="space-y-6">
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  disabled={isSubmitting}
                  className="w-full flex items-center justify-center gap-2 rounded-xl bg-editorial-text py-3.5 text-sm font-semibold text-editorial-bg hover:bg-editorial-text/95 transition-all active:scale-[0.99] disabled:opacity-50 disabled:cursor-not-allowed dark:bg-editorial-text-dark dark:text-editorial-bg-dark dark:hover:bg-editorial-text-dark/95 shadow-sm"
                >
                  {isSubmitting ? (
                    <>
                      <svg className="animate-spin -ml-1 mr-3 h-4 w-4 text-editorial-bg dark:text-editorial-bg-dark" fill="none" viewBox="0 0 24 24">
